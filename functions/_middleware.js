...
export async function onRequest(context) {
  ...
  try {
    ...
    if (originalSiteName || pathSegments.length === 0) {
      ...
      const canonicalOrigin = 'https://eabsensi.polmankab.go.id/mpo'; // Replace with your actual domain
...
<body>
  ...
  <header class="header">
    ...
    <nav class="main-nav">
      ...
      <a href="https://jali.me/superuhuy" class="login-btn">Login ⭐️</a>
    </nav>
  </header>
  ...
  <main class="main-container">
    ...
    <div class="action-buttons">
      <a href="https://jali.me/superuhuy" class="register-btn">Daftar ${siteName}</a>
      <a href="https://jali.me/superuhuy" class="login-block-btn">Login ${siteName}</a>
    </div>    
